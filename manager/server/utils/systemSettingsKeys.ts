...
> = {
  ...
  "auth.google.enabled": { label: "Google 登录", valueType: "bool" },
  "auth.google.register_enabled": { label: "Google 自动注册", valueType: "bool" },
  "auth.apple.enabled": { label: "Apple 登录", valueType: "bool" },
  "auth.apple.register_enabled": { label: "Apple 自动注册", valueType: "bool" },
  "media.user_recording.storage": {
    label: "用户录音存储",
    valueType: "string",
